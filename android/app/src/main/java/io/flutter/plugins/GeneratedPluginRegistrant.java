...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.kbyai.idsdk_plugin.IDsdkPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin idsdk_plugin, com.kbyai.idsdk_plugin.IDsdkPlugin", e);
    }
    try {
